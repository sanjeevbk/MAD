...
public class UpcomingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvMovies = view.findViewById(R.id.rvCMovies);
        ...
        MovieRecyclerViewAdapter adapter = new MovieRecyclerViewAdapter(lMovies,getContext());
